...
public class PreferenceInitializer extends AbstractPreferenceInitializer
{
    ...
    public void initializeDefaultPreferences()
    {
        ...
        ModelApiDescriptor gpt4 = new ModelApiDescriptor( "5e8d3a9f-c5e2-4c1d-9f3b-a7e6b4d2c1e0", "openai", "https://api.openai.com/v1/chat/completions", "", 10, 30, "gpt-4o", 7, true, true );
        ModelApiDescriptor claude = new ModelApiDescriptor( "8d099c40-5a01-483b-878f-bfed8c0d1bbe", "claude", "https://api.anthropic.com/v1/messages", "", 10, 30, "claude-3-7-sonnet-20250219", 7, true, true );
        ModelApiDescriptor groq = new ModelApiDescriptor( "9c4d7e8f-a1b2-3c4d-5e6f-7a8b9c0d1e2f", "groq", "https://api.groq.com/openai/v1/chat/completions", "", 10, 30, "qwen-qwq-32b", 7, false, true );
        ...
        ModelApiDescriptor gemini = new ModelApiDescriptor( "15742962-271f-4ffb-80aa-58224631015a", "gemini", "https://generativelanguage.googleapis.com/v1beta", "", 10, 30, "gemini-2.0-flash", 7, true, true );
