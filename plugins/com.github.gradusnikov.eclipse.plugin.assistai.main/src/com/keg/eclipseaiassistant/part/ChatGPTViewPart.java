...
import com.keg.eclipseaiassistant.part.Attachment.UiVisitor;
import com.keg.eclipseaiassistant.part.dnd.DropManager;
import com.keg.eclipseaiassistant.prompt.PromptParser;
...
public class ChatGPTViewPart
{
    ...
    private String loadCss()
    {
        ...
        {
            try (InputStream in = FileLocator.toFileURL( new URL( "platform:/plugin/com.keg.eclipseaiassistant.plugin.eclipseaiassistant.main/css/" + file ) )
                    .openStream())
            {
    ...
    private String loadJavaScripts()
    {
        ...
        {
            try (InputStream in = FileLocator.toFileURL( new URL( "platform:/plugin/com.keg.eclipseaiassistant.plugin.eclipseaiassistant.main/js/" + file ) )
                    .openStream())
            {
        ...
        public void add( ImageData preview, String caption )
        {
            ...
            try
            {
                imageDescriptor = Optional.ofNullable( preview ).map( id -> ImageDescriptor.createFromImageDataProvider( zoom -> id ) ).orElse(
                        ImageDescriptor.createFromURL( new URL( "platform:/plugin/com.keg.eclipseaiassistant.plugin.eclipseaiassistant.main/icons/folder.png" ) ) );
            }
