...
public class FunctionExecutor
{
    ...
    public Method[] getFunctions()
    {
        return Arrays.stream( functions.getClass().getDeclaredMethods() )
                .filter( method -> Objects.nonNull( method.getAnnotation( com.keg.eclipseaiassistant.commands.Function.class ) ) )
                .toArray( Method[]::new );
    }
    ...
    public CompletableFuture<Object> call( String name, Map<String, String> args )
    {
        ...
        method.getAnnotationsByType( com.keg.eclipseaiassistant.commands.FunctionParam.class );
    ...
    {
        return Optional.ofNullable( parameter.getAnnotation( com.keg.eclipseaiassistant.commands.FunctionParam.class ) )
    ...
    {
        return Optional.ofNullable( method.getAnnotation( com.keg.eclipseaiassistant.commands.Function.class ) )
                .map( Function::name )
                .filter( Predicate.not(String::isBlank))
